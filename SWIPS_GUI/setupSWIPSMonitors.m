function monitors = setupSWIPSMonitors(instruments)
    ...
    monitors = struct(...
        ...
        'rawLCnt', monitor('readFunc', @(x) x.parent.lastRead(1), ...
                        'textLabel', 'rawLCnt', ...
                        'unit', 'Cts', ...
                        'group','inst',...
                        'parent', instruments.SWIPS_OK, ...
                        'formatSpec', "%d," ...
                        ), ...
        'rawUCnt', monitor('readFunc',  @(x) x.parent.lastRead(2), ...
                        'textLabel', 'rawUCnt', ...
                        'unit', 'Cts', ...
                        'group','inst',...
                        'parent', instruments.SWIPS_OK, ...
         ...
         'PPACnt', monitor('readFunc',  @(x) x.parent.lastRead(3), ...
                        'textLabel', 'PPACnt', ...
                        'unit', 'cts', ...
                        'group','inst',...
                        'parent', instruments.SWIPS_OK ...
