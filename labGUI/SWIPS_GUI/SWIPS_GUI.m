    ...
    methods (Access = public)
        ...
        function createLayout(obj)
            ...
            obj.hLvpsPowerOnBtn = uicontrol(obj.hLvpsGrp, ...
                'Style', 'pushbutton', ...
                'Position', [xgap, ygap, 100, obj.ysize], ...
                'String', 'Power ON', ...
                'FontSize', 10, ...
                'FontWeight', 'bold', ...
                'BackgroundColor', [0.7, 0.7, 0.7], ...
                'Callback', @(~,~) obj.Hardware.swips_lvps.setOutputState([1,1],[2,3]));

            % Power Off button for LVPS outputs 1 and 2
            obj.hLvpsPowerOffBtn = uicontrol(obj.hLvpsGrp, ...
                'Style', 'pushbutton', ...
                'Position', [xgap*2+100, ygap, 100, obj.ysize], ...
                'String', 'Power OFF', ...
                'FontSize', 10, ...
                'FontWeight', 'bold', ...
                'BackgroundColor', [0.7, 0.7, 0.7], ...
                'Callback', @(~,~) obj.Hardware.swips_lvps.setOutputState([0,0],[2,3]));

            % Listener to update button colors when OutputState changes
            addlistener(obj.Hardware.swips_lvps, 'OutputState', 'PostSet', ...
        ...
        function updateLvpsButtonColors(obj)
            state = obj.Hardware.swips_lvps.OutputState;
