                 ...
                 'pressureBeamIG1',monitor('readFunc',@(x) x.parent.lastRead(1),...
                  ...
                  'Ifaraday',monitor('readFunc',@(x) x.parent.lastRead,...
                   ...
                   'rMCP',monitor('readFunc',@(x) x.parent.lastRead,...
                    ...
                    'mcpIout', monitor('readFunc', @(self) self.parent.lastIRead(1:2), ...
                                    'textLabel', 'MCP Iout', ...
                                    'unit', 'uA', ...
                                    'active', false, ...
                                    'formatSpec', '%.1f,', ...
                                    'group', 'ImgMCP', ...
                                    'monitorLength', 2, ...
                                    'parent', instruments.caen_HVPS2, ...
                                    'listenProp', 'lastIRead' ...
                                    ),...
                    'voltCh1_mcpVout', monitor('readFunc', @(self) self.parent.lastRead(1),...
                                    'setFunc', @(self,volt) self.parent.setVset(0,volt), ...
                                    'textLabel', 'MCP Volt Vout', ...
                                    'unit', 'V', ...
                                    'active', false, ...
                                    'formatSpec', '%.1f', ...
                                    'group', 'ImgMCP', ...
                    ...
                    'voltCh2_mcpVA', monitor('readFunc', @(self) self.parent.lastRead(2),...
                                    'setFunc', @(self,volt) self.parent.setVset(1,volt), ...
                                    'textLabel', 'MCP Volt VA', ...
                                    'unit', 'V', ...
                                    'active', false, ...
                                    'formatSpec', '%.1f', ...
                                    'group', 'ImgMCP', ...
                    ...
                    'voltCh4_cemVA', monitor('readFunc', @(self) self.parent.lastRead(4),...
                                    'setFunc', @(self,volt) self.parent.setVset(3,volt), ...
                                    'textLabel', 'CEM Voltage', ...
                                    'unit', 'V', ...
                                    'active', false, ...
                                    'formatSpec', '%.1f', ...
                                    'group', 'CEM', ...
                     ...
                     'cemIout', monitor('readFunc', @(self) self.parent.lastIRead(4), ...
                                    'textLabel', 'CEM Iout', ...
                                    'unit', 'uA', ...
                                    'active', false, ...
                                    'formatSpec', '%.1f,', ...
                    ...
                    'tempTC', monitor('readFunc', @(self) self.parent.lastRead(1:4), ...
                                    'textLabel', 'Temperature TC', ...
                                    'unit', 'degC', ...
                                    'active', false, ...
                                    'formatSpec', '%.1f,', ...
                                    'monitorLength', 3, ...
...
%             y_ratio = 25/10000; %Calibrated y-steer ratio
    ...
    monitors.IExt = monitor('readFunc',@(x) abs(x.parent.lastRead(4)*3/10),...
                                 'textLabel','Extraction Current',...
                                 'unit','mA',...
                                 'active',false,...
                                 'formatSpec','%.2f',...
                                 'group','beam',...
    ...
    monitors.valveState1 = monitor('readFunc',@interlock_read,...
                                 'textLabel','Valve State 1',...
                                 'unit','T/F',...
                                 'active',false,...
                                 'group','systemState',...
                                 'formatSpec','%d,',...
    ...
    monitors.valveState2 = monitor('readFunc',@(self) double(self.parent.lastRead(1:3)),...
                                 'textLabel','Valve State 2',...
                                 'unit','T/F',...
                                 'active',false,...
                                 'group','systemState',...
                                 'formatSpec','%d,',...
                                 'monitorLength',2,...
                                 'parent',instruments.webpowerstrip2...
                                 );

    monitors.doorState = monitor('readFunc', @(self) self.parent.lastRead(end)<10000, ...
                                    'textLabel', 'Door Open', ...
                                    'unit', '[T/F]', ...
                                    'active', false, ...
                                    'formatSpec', '%d', ...
    ...
    function cryoTemp = cryo_temp_interlock_read(self)
        ...
        interloc_outlet = 5;
        if all(self.parent.Connected)
            cryoTemp = self.parent(2).lastRead(5)*100; %convert to degK
            gateValveState = self.siblings.lastRead(interloc_outlet);
            if gateValveState && cryoTemp>19
                warning('%s Interlock Triggered at %s',self.Tag,datetime("now"))
                self.parent(1).setOff(interloc_outlet);
                self.parent(1).read();
            end
        else 
            cryoTemp = nan;
    ...
    monitors.cryoTemp = monitor('readFunc',@cryo_temp_interlock_read,...
                                 'textLabel','Cryo Temp',...
                                 'unit','degK',...
                                 'active',false,...
                                 'plot',false,...
