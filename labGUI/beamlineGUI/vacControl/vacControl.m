classdef vacControl < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createLayout(obj)
            ...
            % Figure menu bar entry to refresh either power-strip webpage
            mVacControl = uimenu(obj.hFigure, 'Text', 'Vac Control');
            uimenu(mVacControl, 'Text', 'Refresh Power Strip 1', ...
                'MenuSelectedFcn', @(~,~) displayWebPage('http://192.168.0.110/', pan_valveControl));
            uimenu(mVacControl, 'Text', 'Refresh Power Strip 2', ...
                'MenuSelectedFcn', @(~,~) displayWebPage('http://192.168.0.109/', pan_valveControl2));
            ...
            valveOverlays = { ...
                ...
                'ChamberRoughV1', 8, [0.84,0.093,0.039,0.031049370331502], 'valveState1'; ...
                'ChamberRoughV2', 7, [0.645722744445754,0.195,0.039375892298346,0.031049370331502], 'valveState1'; ...
                'Cryo1RoughV',    1, [0.75,0.128,0.04,0.0284], 'valveState2'; ...
            };
            ...
            for k = 1:size(valveOverlays, 1)
                ...
                x_rect =pos(1) * imgW;
                y_rect = (1 - (pos(2) + pos(4)) / (1 - vfrac)) * imgH;
                w_rect = pos(3) * imgW;
